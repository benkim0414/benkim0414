...
const expectedSkillSet = [
  ...
  ['monitoring-observability-skill-grafana-alloy', 'Grafana Alloy'],
...
const approvedPublicSkillText = [
  ...
  'Grafana Alloy',
  'Evidence-backed Monitoring and Observability capability with Grafana Alloy.',
  'Kubernetes',
